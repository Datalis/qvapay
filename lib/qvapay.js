...
class Qvapay {
     ...
     * 
     * @returns {Promise} Objeto JSON con los datos de la app
     *  {
     *       "user_id":1,
     *       "name":"my_website",
    ...
    create_invoice(amount, description, remote_id, signed = true) {
        ...
        return axios.get('/create_invoice', {
            params
        })
    }
     ...
     * 
     * @returns {Promise} La solicitud de transacciones será devuelta con un paginado de 50 transacciones ordenadas desde las más reciente hasta la más antigua.
     * {
     *   "current_page": 1,
     *   "data": [
     *       {
     ...
     * 
     * @returns {Promise} La solicitud de dicha transacción será devuelta con los datos relacionados a dicha transacción como el owner de la aplicación y la aplicación en sí.
     * 
     * {
    ...
    transaction(uuid) {
        ...
        return axios.get(`/transaction/${uuid}`, {
            params: {
                app_id: this.APP_ID,
                app_secret: this.APP_SECRET
            }
     ...
     * 
     * @returns {Promise} Devuelve el balance de la cuenta
     * 
     * "66.00"
     * 
     */
